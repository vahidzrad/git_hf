...
class Gtheta(object):
    ...
    def __init__(self, problem):
        ...
        # Parameters
        self.x0 = 0.0  # x-coordinate of the crack tip
        self.y0 = 0.0  # y-coordinate
        self.r = 0.01  # inner radius
        self.R = 0.02  # outer radius

        # Theta field
        self.problem = problem
        self.V_theta = VectorFunctionSpace(problem.mesh, "CG", problem.parameters.fem.alpha_degree)
        self.theta = Function(self.V_theta, name="Theta")
        self.theta_trial = TrialFunction(self.V_theta)
        self.theta_test = TestFunction(self.V_theta)
        self.f_theta = XDMFFile(mpi_comm_world(), problem.save_dir + "theta.xdmf")
