...
def Diffusion():
	...
	#Input data:
	#-----------------------------------------------------------------------------------------
	nIter=5 # number of time steps
	hsize = 0.1 # mesh size for reading the mesh file generated by phase field class
	pore=0.01 #porosity
	...
	P_V = Expression("1*t/t_stop*Init_Pressure",t_stop= t_stop_a, Init_Pressure=Init_Pressure, t=0.0, degree=1)
