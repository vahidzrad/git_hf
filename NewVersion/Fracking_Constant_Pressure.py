...
#
# A Quasi static solution of the pressurized fracture problems using the regularization AT2, Model A (Isotropic Model).
#
# according to:
# B.Bourdin et al., 2012 , SPE 159154, equation (5)
# M.F. Wheeler et al., CAMAME, 2014, eqution (4)
#
# B.Bourdin et al., 2012 have used degradation function as follow:  g(alpha_) = (1-alpha_)**2,
# Wheeler et al., 2014 have used degradation function as follow:    g(alpha_) = (1-k_ell) * (1-alpha_)**2 + k_ell,
# and we have used degradation function according model A : 	    g(alpha_) = (1-alpha_)**2 + k_ell
...
save_dir = "Fracking_Constant_P_result/" + prefix + "/"
