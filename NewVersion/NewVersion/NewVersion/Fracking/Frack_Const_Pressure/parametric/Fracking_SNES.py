...
pressure_steps = 2 # number of time steps
...
problem_u = NonlinearVariationalProblem(F_u, u_, bc_u, J_u)
...
plt.plot(x, width, '-', dashes=[8, 4, 2, 4, 2, 4], label='Senddon, $p=$ %s'%pressure_max)
plt.plot(x_, width_, '-', dashes=[8, 4, 2, 4, 2, 4])
