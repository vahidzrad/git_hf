...
def Opening(hsize):
	...
	u = Function(V_u)
	input_file_u = HDF5File(mesh.mpi_comm(), "u_4_opening.h5", "r")
	input_file_u.read(u, "solution")
	input_file_u.close()

	alpha = Function(V_alpha)
	input_file_alpha = HDF5File(mesh.mpi_comm(), "alpha_4_opening.h5", "r")
	...
	editor.open(mesh_h,1,2)  #Mostafa: Are you mapping the 1D mesh(crack) on 2D domain?
